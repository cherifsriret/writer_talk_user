...
<div class="d-flex">
        ...
        @if($is_user->uuid != \Illuminate\Support\Facades\Auth::user()->uuid)
                    ...
                    @if($is_user->penpal_status == 'Add Friend')
                            <form action="{{url('add-penpal')}}" method="post">
                                @csrf
                                <input type="hidden" name="receiver_id" value="{{$is_user->uuid}}">
			...
			<div class="modal-body text-center">
				...
				<div class="">
					<div class="uploaded-pdf-view text-center  pt-3"> {{--
                        ...
                        <div class="mt-4">
                        <button type="button" class="btn btn-white Praise highlight_comment_tab">Praise</button>
                        <button type="button" class="btn btn-white Critique highlight_comment_tab">Critique</button>
                        </div>
						<div class="px-5">

                            <div class="tips-type mt-1">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item w-50 " > <a class="nav-link font-md font-weight-bold text-center active show pros" id="pros-tab" data-toggle="tab" href="#Posts" role="tab" aria-controls="Posts" aria-selected="true">Praise</a> </li>
                                    <li class="nav-item w-50 "> <a class="nav-link font-md font-weight-bold text-center cons" id="cons-tab" data-toggle="tab" href="#My-Tips" role="tab" aria-controls="My-Tips" aria-selected="false">Critique</a> </li>
                                </ul>
                            ...
                            <div class="modal-dialog  modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body w-100">
                                        ...
                                        <div class="avatar-upload">
                                        <div class="avatar-edit">
                                        <input type='file' id="imageUpload-1" accept=".png, .jpg, .jpeg" />
                                        <label for="imageUpload"></label>
                                        </div>
                                        <div class="avatar-preview">
                                        <div id="imagePreview-1" style="background-image: url({{asset('storage/assets/imgs/2.jpg')}});">
                                        </div>
                                        </div>
                                        </div>
                                        ...
                                        <input type="text" class="form-control input-name m-0" id="exampleFormControlInput1" placeholder="Name">
                                        </div>
                                        <div class="enter-name">
                                        <label for="exampleFormControlInput2" class="form-label person-name">Bio</label>
                                        <input type="text" class="form-control input-name m-0" id="exampleFormControlInput2" >
                                        </div>
                                        <div class="enter-name">
                                        <label for="exampleFormControlInput3" class="form-label person-name">Contact</label>
                                        <input type="text" class="form-control input-name m-0" id="exampleFormControlInput3" placeholder="454-658-351">
                                        </div>
                                        <div class="enter-name">
                                        <label for="exampleFormControlInput4" class="form-label person-name">Email</label>
                                        <input type="email" class="form-control input-name m-0" id="exampleFormControlInput4" placeholder="u1@gmail.com">
                                        </div>
                                        <button type="button" class="btn btn-primary Submit-Document mt-2 mb-0">Profile Update</button>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success == true){
                    ...
                    $("#highlight_image_anc").attr('href','http://admin.writerstalkadmin.com/public/storage/'+highlight_data.file)
                    $("#highlight_image_anc").find('img').attr('src',"http://admin.writerstalkadmin.com/public/storage/"+highlight_data.file_image)
                    ...
                    if (highlight_data.praise_comments.length > 0){
                        $.map(highlight_data.praise_comments, function(item, index){
                            var praise_html = "<div class=\"media\"> <img class=\"mr-3 single-user-name\" src='http://admin.writerstalkadmin.com/public/storage/"+item.user.image+"' alt=\"Generic placeholder image\">\n" +
                                "                                                    <div class=\"media-body mt-1 text-left\">\n" +
                    ...
                    if (highlight_data.critique_comments.length > 0){
                        $.map(highlight_data.critique_comments, function(item, index){
                            var critique_html = "<div class=\"media\"> <img class=\"mr-3 single-user-name\" src='http://admin.writerstalkadmin.com/public/storage/"+item.user.image+"' alt=\"Generic placeholder image\">\n" +
                                "                                                    <div class=\"media-body mt-1 text-left\">\n" +
                                "                                                        <h5 class=\"mt-0 main-name\">"+item.user.name+"</h5>\n" +
                                "                                                        <p class=\"review\">"+item.comment+"</p>\n" +
                                "                                                        <div class=\"time last-seen\">"+item.comment_created_at_formatted+"</div>\n" +
